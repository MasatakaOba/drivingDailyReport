...
<div>
  ...
  try {
    ...
    // SQL文を作る
    $sql = "INSERT INTO driverecord (shimeicd, date, time, item, park_use, park_fee, day_over, odometer/*, highway_use, highway_fee, oil_pay, oil_fee, oil_quantity*/) ,VALUES (:shimeicd, :date, :time, :item, :park_use, :park_fee, :day_over, :odometer/*, :highway_use, :highway_fee, :oil_pay, :oil_fee, oil_quantity*/)";
    //
    // プリペアドステートメントを作る
    $stm = $pdo->prepare($sql);
    // プレースホルダに値をバインドする
  ...
  <input class="button" type="submit" value="TOP">
  </form>
